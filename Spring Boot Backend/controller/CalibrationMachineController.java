...
@RestController
// @RequestMapping("ground-floor/api/v1/")
@RequestMapping("root/api/v1/")
public class CalibrationMachineController {
    ...
    @GetMapping("/calibrationMachines/byFloor/{floor}")
    public List<CalibrationMachine> getMethodName(@PathVariable String floor) {
