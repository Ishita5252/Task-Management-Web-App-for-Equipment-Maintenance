...
function ListCalibrationMAcineComonent(){
    ...
    const editMachine = (id) => {
        navigate(`/calibrationMachine/add-calibration-machine/${id}`);
    }

    const addMachine = () => {
        navigate(`/calibrationMachine/add-calibration-machine/_add`);
    }

    const viewRecordByArea = (area) => {
        navigate(`/calibrationMachine/view-record/${area}`)
    }
